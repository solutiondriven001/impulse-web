        ...
        <ScrollArea className="h-[220px] pr-3">
            <ul className="space-y-3">
              {sortedLeaderboard.map((user, index) => (
                ...
                >
                  <span className={`flex items-center justify-center mr-4 font-bold w-8 text-lg ${index === 0 ? 'text-yellow-400' : (index === 1 || index === 2) ? 'text-slate-400' : 'text-card-foreground/70'}`}>
