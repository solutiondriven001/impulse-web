...
const initialLeaderboardData: LeaderboardEntry[] = [
  ...
  { id: '2', name: 'MiningMaster', score: 1520, avatarSeed: 'MM' },
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-background to-purple-800 text-foreground selection:bg-accent selection:text-accent-foreground">
      ...
      <main className="flex-grow container mx-auto p-4 md:p-6 lg:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Column 3: Leaderboard & Ads (Ads moved here for better balance on some screens) */}
        ...
        <section className="mt-12 p-6 bg-card text-card-foreground rounded-xl shadow-lg">
          <h2 className="text-2xl font-headline font-semibold mb-4 flex items-center">
            ...
            How to Play CoinQuest
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
            <div className="p-3 bg-card-foreground/5 rounded-lg">
              <h3 className="font-semibold flex items-center mb-1"><BarChartBig className="w-5 h-5 mr-1.5 text-accent"/>Mine Coins</h3>
              <p className="text-card-foreground/80">Activate the miner and claim your coins when the cycle completes. Higher levels yield more coins!</p>
            </div>
            <div className="p-3 bg-card-foreground/5 rounded-lg">
            ...
            <div className="p-3 bg-card-foreground/5 rounded-lg">
             ...
             <div className="p-3 bg-card-foreground/5 rounded-lg">
              ...
              <p className="text-card-foreground/80">Compete with other players and show off your mining prowess by reaching the top ranks!</p>
            </div>
          </div>
        </section>
      </main>
      <footer className="text-center p-4 text-sm text-foreground/70">
        © {new Date().getFullYear()} CoinQuest. All rights reserved.
      </footer>
    </div>
  );
}
